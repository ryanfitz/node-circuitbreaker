...
internals.parseArgs = function(argsArray) {
...
CircuitBreaker.prototype._callFunction = function () {
  ...
  var args = internals.parseArgs(arguments);
  var callbackHandler = self._callbackHandler(deferred);
  args.push(callbackHandler);

  setTimeout(function () {
    return callbackHandler(new Error('CircuitBreaker timeout'));
  }, self.timeout);
...
CircuitBreaker.prototype._callbackHandler = function(deferred) {
  var self = this;
